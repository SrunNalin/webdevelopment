...
<html lang="en">
  <head>
    <title>Payment Successful Confirmation | Waterest Hotels & Resorts</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/index ">Home</a></span> <span>Make a reservation</span></p>
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-12 mb-4">
            <h2 class="h3">You booking was sent! Any update we will send to you later <span class="icon icon-verified_user"></span><span class="text"></span></h2>
            <br>
            Your request to book the following room(s) was successfully completed. You may now <a href="/index ">return to the homepage</a>. For any inquiries, please kindly refer to our <a href="contact.html">contact page</a>.
          </div>
          </div>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text"></span>+855 39 392 210</span></a></li>
