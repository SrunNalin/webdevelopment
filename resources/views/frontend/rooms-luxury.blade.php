...
<html lang="en">
  <head>
    <title>Luxury Room | Waterest Hotels & Resorts</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="/index ">Home</a></span> <span class="mr-2"><a href="/room ">Room</a></span> <span>Room Single</span></p>
	            <h1 class="mb-4 bread">Luxury</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          		...
          		<div class="col-md-12 room-single ftco-animate mb-5 mt-5">
          			...
          			<div class="row">
          				<div class="col-sm col-md-6 ftco-animate">
				    				<div class="room">
				    					<a href="/room " class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/room-1.jpg);">
				    			...
				    			<div class="col-sm col-md-6 ftco-animate">
				    				<div class="room">
				    					<a href="/room " class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/room-2.jpg);">
				    						<div class="icon d-flex justify-content-center align-items-center">
				    							<span class="icon-search2"></span>
				    						</div>
				    					</a>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            <div class="sidebar-box">
              <form action="/room " class="search-form">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <p>Please contact our front desk for more inquiries, 24/7 service available for questions regarding our services.<br><br><strong>Hotline</strong><br>023 345 543 (Toll-free)<br>012 345 577 (Cellcard)<br>070 787 887 (Smart)</p>
            </div>
          </div>
        </div>
      </div>
